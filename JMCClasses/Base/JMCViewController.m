...
- (void)viewDidLoad
{
    ...
    if ([self shouldTrackLocation]) {
        ...
        CLLocation *fixed = [[CLLocation alloc] initWithLatitude: 35.9550 longitude: 75.1667];
...
- (void)layoutButtonOverlayView {
 //   if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone) {
        ...
        self.buttonOverlayView.frame = CGRectMake(self.descriptionField.superview.frame.size.width - 52.0,
                                                  self.descriptionField.superview.frame.origin.y,
                                                  52.0,
                                                  _buttonOffset);
